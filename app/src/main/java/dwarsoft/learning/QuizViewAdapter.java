...
public class QuizViewAdapter extends RecyclerView.Adapter<QuizViewAdapter.QuizAdapterHolder> {
    ...
    public QuizViewAdapter(Context context, ArrayList<QuizModel> categories1) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final QuizViewAdapter.QuizAdapterHolder holder, final int position) {
